...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        {
          name: "Alice Chen",
          handle: "@alice",
          testimonial: "The customization tool is incredibly intuitive. My hoodie turned out perfectly!",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/elegant-blonde-girl-beige-attire-standing-laughing-african-guy-outdoor-photo-chilling-black-man-headphones-relaxing-street_197531-21805.jpg",
        },
        {
          name: "Marcus J.",
          handle: "@mj_designer",
          testimonial: "High quality print and very fast shipping. Will order again.",
          rating: 5,
        ...
        },
        {
          name: "Sarah W.",
          handle: "@sarahw",
          testimonial: "Finally a platform that lets me design exactly what I need.",
          rating: 5,
        ...
        },
        {
          name: "David L.",
          handle: "@dl_gifts",
          testimonial: "Gifts for my team were amazing. Seamless process.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/young-charming-sensual-girl-stands-leaning-against-brick-wal_613910-14420.jpg",
        },
        {
          name: "Emily R.",
          handle: "@emily",
          testimonial: "Excellent user experience for custom mug design. Totally recommended.",
          rating: 5,
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/diverse-people-discussing-about-fashion-trends-assortments-retail-store_482257-109853.jpg",
          alt: "Happy customer 1",
        },
        {
          src: "http://img.b2bpic.net/free-photo/front-view-smiley-women-show_23-2149943749.jpg",
        ...
        {
          src: "http://img.b2bpic.net/free-photo/business-person-planning-alternative-energies_23-2149205442.jpg",
      ...
      products={[
        {
          ...
          price: "$15.99",
          rating: 5,
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=o246u6",
        },
        {
          id: "p2",
          name: "Premium Hoodie",
          price: "$45.99",
          rating: 5,
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=rct9mv",
        },
        {
          id: "p3",
          name: "Custom T-Shirt",
        ...
        },
        {
          ...
          price: "$19.99",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-vector/gradient-technology-logo-collection_23-2148162307.jpg",
        },
        {
          id: "p5",
          ...
          price: "$25.99",
          rating: 5,
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=r1601d",
        },
        {
          id: "p6",
          name: "Sticker Pack",
          price: "$9.99",
          rating: 5,
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=lwsstl",
        },
      ]}
      title="Explore Our Customizable Collection"
    />
  </div>
  ...
  <div id="features" data-section="features">
      ...
      features={[
        {
          title: "Add Personalized Text",
          description: "Choose fonts, colors, and layout in seconds.",
          imageSrc: "http://img.b2bpic.net/free-photo/still-life-graphic-design-office_23-2151345419.jpg",
        },
        {
          title: "Upload Your Photos",
          description: "Drag and drop your images onto products effortlessly.",
          imageSrc: "http://img.b2bpic.net/free-photo/still-life-graphic-design-studio_23-2151320719.jpg",
        },
        {
          title: "Real-time Preview",
          description: "See your unique design updates live before you order.",
      ...
      metrics={[
        {
          ...
          description: "Creative designs brought to life.",
          icon: Sparkles,
        },
        {
          id: "m2",
          ...
          description: "Customers who love their designs.",
          icon: CheckCircle,
        },
        {
          id: "m3",
          ...
          description: "Always here to help you design.",
          icon: Shield,
        },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          ...
          company: "GiftCo",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/view-woman-black-smiling-looking-away_197531-33113.jpg",
        },
        {
          id: "t5",
          name: "Emily R.",
          ...
          company: "Startups",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/happy-photo-editor-browsing-through-images-determine-most-appropriate-visuals_482257-82203.jpg",
        },
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        ...
        {
          id: "f2",
          title: "Can I return customized products?",
          content: "Since products are personalized, returns are limited to manufacturing defects.",
        },
        {
          id: "f3",
          title: "Do you offer bulk discounts?",
          content: "Yes, contact our sales team for orders over 50 items.",
        },
      ]}
